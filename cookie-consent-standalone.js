 ...
 * 
 * Features:
 * - Google Analytics 4 integration (G-4G8HC9L0PY)
 * - Cookie banner with Accept All, Accept Essentials Only, Customize options
 * - AI cursor prompt (hover for 2 seconds to show interactive popup)
 * - localStorage consent storage
 * - IP anonymization and secure cookie settings
 */
...
(function() {
    ...
    const CONFIG = {
        ...
        CURSOR_HOVER_DELAY: 2000, // 2 seconds
    ...
    function createCookieBanner() {
        ...
        // AI cursor prompt - hover detection
        setupAICursorPrompt(banner);
    }

    /**
     * Setup AI cursor prompt (hover for 2 seconds)
     */
